...
Amino_Acids[ASP]="Aspartate"
Amino_Acids[CYS]="Cysteine"
Amino_Acids[GLU]="Glutamate"
Amino_Acids[GLN]="Glutamine"
Amino_Acids[GLY]="Glycine"
Amino_Acids[HIS]="Histidine"
Amino_Acids[ILE]="Isoleucine"
Amino_Acids[LEU]="Leucine"
Amino_Acids[LYS]="Lysine"
Amino_Acids[MET]="Methionine"
Amino_Acids[PHE]="Phenylalanine"
Amino_Acids[PRO]="Proline"
Amino_Acids[SER]="Serine"
Amino_Acids[THR]="Threonine"
Amino_Acids[TRP]="Tryptophan"
Amino_Acids[TYR]="Tyrosine"
Amino_Acids[VAL]="Valine"
#Display
echo -e "Welcome to the 'PDB' Histogram program"

echo -e "File under reference  $#"
...
case $command in
    ...
    "help") # try making a table with command and info towards command
        ...
        echo -e "                      Usage:atominfo <element_names>"
        echo -e "                      Example:atominfo <carbon nitrogen>"
        echo -e ""
